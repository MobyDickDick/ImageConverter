...
- Ergebnis:
  - Exit `0`
  - `1 skipped, 5 warnings in 1.99s`
- Log:
  - `artifacts/converted_images/reports/TB_A3_timeout_probe_2026-05-25_runKU.log`

## 2) Gekoppelte Plan-B-Aufgabe
- Befehl:
  - `PYTHONPATH=. python3 tools/plan_b_synthetic_probe.py "Bildbeschreibung: Kreis mit horizontalem Griff links und Beschriftung rF." --variant AC0140_S --output-dir artifacts/converted_images/reports`
- Ergebnis:
  - Exit `0`
  - `status=ok`, `variant=AC0140_S`
- Log:
  - `artifacts/converted_images/reports/AC0140_S_planb_synthetic_2026-05-25_runKU.log`

## 3) Nächstes CSV-Bild
- Einzellauf:
  - `PYTHONPATH=. timeout 240 python3 -m src.iCCModules.imageCompositeConverterCli --input-dir artifacts/images_to_convert --output-dir artifacts/converted_images --start AC0140_S --end AC0140_S`
- Ergebnis:
  - Exit `0`
- Log:
  - `artifacts/converted_images/reports/AC0140_S_single_2026-05-25_runKU.log`
...
- Ergebnis:
  - Exit `0`
  - `533 passed, 5 warnings in 4.95s`
- Log:
