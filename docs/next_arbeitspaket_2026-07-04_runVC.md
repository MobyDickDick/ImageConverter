# Nächstes Arbeitspaket – PolygonPath Ultrafine-Stroke-Width-Probes Run VC (2026-07-04)

Run VC greift nach Run VB den dokumentierten Anschluss „weitere allgemeine
Antialiasing-/Stroke-Feintuning-Probes“ auf. Der Fokus bleibt katalogfrei:
`PolygonPath`-Konturen erhalten zusätzliche ultrafeine absolute `stroke_width`-
Probes, damit Diagramm-, Dreieck- und Hakenkonturen genauer gegen
