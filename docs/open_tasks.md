...
- **Nächster sinnvoller Schritt:** Mit `AC0232_S.jpg` rotieren oder vor der regulären Rotation einen QR-Folgepunkt (`AC0838_M` oder `AC0881_M`) als isolierten Plan-B-/Re-Konvertierungslauf abarbeiten.
