...
- [x] C1.1: Erste Extraktion abgeschlossen: Regionen-Analyse/Annotierung aus dem Monolithen ausgelagert.
  ...
  - 2026-04-19: Umsetzung abgeschlossen; neuer Sequenz-Helper
    ...
    Runner-Entry-Point.
  - [x] C1.131: Finale Runner-For-Run-Kwargs-Verdrahtung aus `runIterationPipelineImplFromInputsDispatchCallForRunImpl` modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neues Mapping-Helperpaar
    ...
    extrahiert den bisherigen Abschluss-Keyword-Aufbau für den Runner-Aufruf
    in einen separaten, detailtestabgedeckten Mapping-Schritt.
  - [x] C1.132: Finale Runner-Kwargs-Sequenz aus `runIterationPipelineImplFromInputsDispatchCallForRunImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neuer Sequenz-Helper
  ...
  - [x] C1.134: Top-Level-Orchestrierungs-Dispatch-Call-Sequenz aus `runIterationPipelineImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neues Helperpaar
    ...
    `runIterationPipelineImplOrchestrationDispatchForRunImpl`) in einen
    separaten, detailtestabgedeckten Sequenz-Schritt.
  - [x] C1.135: Top-Level-From-Inputs-Dispatch-Call-Sequenz aus `runIterationPipelineImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neues Helper-Tripel
    `buildRunIterationPipelineImplFromInputsDispatchCallForRunCallKwargsImpl` /
    `buildRunIterationPipelineImplFromInputsDispatchCallForRunCallKwargsForRunImpl` /
    ...
    `runIterationPipelineImplFromInputsDispatchCallForRunImpl`) in einen
    separaten, detailtestabgedeckten Sequenz-Schritt.
  - [x] C1.136: Top-Level-Orchestrierungs-Dispatch-Call-Sequenz aus `runIterationPipelineImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neues Helper-Tripel
    ...
    kapselt den bisherigen direkten Inline-Aufruf
    (`buildRunIterationPipelineImplOrchestrationDispatchForRunCallKwargsImpl` +
    `runIterationPipelineImplOrchestrationDispatchForRunCallForRunImpl`) in einen
    separaten, detailtestabgedeckten Sequenz-Schritt.
  - [x] C1.137: Top-Level-From-Inputs-Dispatch-Call-Sequenz aus `runIterationPipelineImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neues Helper-Tripel
    ...
    kapselt den bisherigen direkten Inline-Aufruf
    (`buildRunIterationPipelineImplFromInputsDispatchCallForRunCallKwargsForRunImpl` +
    `runIterationPipelineImplFromInputsDispatchCallForRunSequenceForRunImpl`) in einen
    separaten, detailtestabgedeckten Sequenz-Schritt.
  - [x] C1.138: Top-Level-Orchestrierungs-Kwargs-Sequenz aus `runIterationPipelineImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neues Helper-Paar
    ...
    kapselt den bisherigen direkten Inline-Aufruf
    (`buildRunIterationPipelineImplOrchestrationDispatchForRunCallSequenceForRunKwargsImpl` +
    `runIterationPipelineImplOrchestrationDispatchForRunCallSequenceForRunImpl`) in einen
    separaten, detailtestabgedeckten Sequenz-Schritt.
  - [x] C1.139: Top-Level-From-Inputs-Dispatch-Call-Sequenz aus `runIterationPipelineImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neues Helper-Paar
    `buildRunIterationPipelineImplFromInputsDispatchCallSequenceForRunKwargsImpl` /
    `runIterationPipelineImplFromInputsDispatchCallSequenceForRunImpl`
    kapselt den bisherigen direkten Inline-Aufruf
    (`buildRunIterationPipelineImplFromInputsDispatchCallForRunCallSequenceForRunKwargsImpl` +
    `runIterationPipelineImplFromInputsDispatchCallForRunCallSequenceForRunImpl`) in einen
    separaten, detailtestabgedeckten Sequenz-Schritt.
  - [x] C1.140: Top-Level-From-Inputs-Dispatch-Sequence-Eingabemapping aus `runIterationPipelineImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neuer Helper
    `buildRunIterationPipelineImplFromInputsDispatchCallSequenceInputKwargsForRunImpl`
    kapselt den bisherigen direkten Inline-Aufruf von
    `buildRunIterationPipelineImplFromInputsDispatchCallForRunCallKwargsForRunImpl`
    in einen separaten, detailtestabgedeckten Mapping-Schritt.
  - [x] C1.141: Top-Level-From-Inputs-Dispatch-Sequence-Inputwrapper aus `runIterationPipelineImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neuer Helper
    `buildRunIterationPipelineImplFromInputsDispatchCallSequenceForRunInputKwargsForRunImpl`
    kapselt das bisher direkte Inline-Einbetten von
    `buildRunIterationPipelineImplFromInputsDispatchCallSequenceInputKwargsForRunImpl`
    in einen separaten, detailtestabgedeckten Wrapper-Schritt.
  - [x] C1.142: Top-Level-From-Inputs-Dispatch-Sequence-Call-Kwargs aus `runIterationPipelineImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neuer Helper
    `buildRunIterationPipelineImplFromInputsDispatchCallSequenceForRunCallKwargsForRunImpl`
    kapselt den bisher direkten Inline-Aufruf
    (`buildRunIterationPipelineImplFromInputsDispatchCallSequenceForRunInputKwargsForRunImpl` +
  ...
  - 2026-04-19: Umsetzung abgeschlossen; neues Helper-Paar
    ...
    separaten, detailtestabgedeckten Sequenz-Schritt.
  - [x] C1.144: Top-Level-From-Inputs-Dispatch-Sequence-Call-Aufruf aus `runIterationPipelineImpl` weiter modularisieren.
  - 2026-04-19: Umsetzung abgeschlossen; neues Helper-Tripel
    ...
    `runIterationPipelineImplFromInputsDispatchCallSequenceCallForRunCallForRunImpl`
    kapselt den bisherigen direkten Inline-Aufruf
    (`buildRunIterationPipelineImplFromInputsDispatchCallSequenceCallKwargsForRunImpl` +
    `runIterationPipelineImplFromInputsDispatchCallSequenceCallForRunImpl`) in einen
    separaten, detailtestabgedeckten Sequenz-Schritt.
  - Nächster geplanter Schritt: weitere verbleibende Sequenzen aus `runIterationPipeline` in kleinen, testbaren Schritten extrahieren (ab C1.145).
