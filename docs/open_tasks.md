...
- [ ] Harden circle detection for small AC08 variants before the semantic gate runs.
  ...
  - The fixed AC08 regression set now always includes all previously marked good variants (`AC0800_L`, `AC0800_M`, `AC0800_S`, `AC0811_L`) and reports whether any of them regressed or went missing.
