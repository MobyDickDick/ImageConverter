...
- [ ] Harden circle detection for small AC08 variants before the semantic gate runs.
  ...
  - The fixed AC08 regression set now loads its previously marked good variants from `artifacts/converted_images/reports/ac08_previously_good_variants.txt` and reports whether any of them regressed or went missing.
