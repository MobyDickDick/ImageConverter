...
- Ergebnis:
  - Exit `0`
  - `1 skipped, 5 warnings in 2.10s`
- Log:
  - `artifacts/converted_images/reports/TB_A3_timeout_probe_2026-05-27_runLC.log`

## 2) Gekoppelte Plan-B-Aufgabe
- Befehl:
  - `PYENV_VERSION=3.10.20 PYTHONPATH=vendor/linux-py310/site-packages:. python tools/plan_b_roundtrip.py artifacts/images_to_convert/samples/AC0151_L.svg --output-dir artifacts/converted_images/reports`
- Ergebnis:
  - Exit `0`
  - `variant=AC0151_L`, `delta2_output_vs_sample=0.000000`
- Log:
  - `artifacts/converted_images/reports/AC0151_L_planb_roundtrip_2026-05-27_runLC.log`
...
- Ergebnis:
  - Exit `0`
  - `543 passed, 5 warnings in 5.29s`
- Log:
