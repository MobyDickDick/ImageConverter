...
def test_run_main_impl_auto_enables_isolated_render_for_full_ac08_range() -> None:
    args = argparse.Namespace(
        _render_svg_subprocess=False,
        isolate_svg_render=False,
        isolate_svg_render_timeout_sec=4.0,
        log_file="",
        ac08_regression_set=False,
        print_linux_vendor_command=False,
        vendor_dir="vendor",
    ...
    assert "Vollbereich AC0800..AC0899 aktiviert isoliertes SVG-Rendering automatisch" in stdout.getvalue()
