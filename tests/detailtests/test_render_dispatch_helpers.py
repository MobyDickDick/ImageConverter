...
def test_render_svg_to_numpy_forwards_per_call_subprocess_timeout() -> None:
    captured: dict[str, float | None] = {}
    helpers._RENDER_CACHE.clear()

    helpers.renderSvgToNumpyImpl(
        '<svg xmlns="http://www.w3.org/2000/svg"></svg>',
        10,
        5,
        timeout_sec=0.75,
        ...
        under_pytest_runtime=False,
        is_fitz_open_monkeypatched_fn=lambda: False,
        render_svg_to_numpy_via_subprocess_fn=lambda *_a, **kwargs: captured.update(
    ...
    assert captured == {"timeout_sec": 0.75}
