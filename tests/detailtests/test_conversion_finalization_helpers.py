...
def test_run_conversion_finalization_executes_all_steps_and_returns_semantic_results(tmp_path):
    ...
    result = finalization_helpers.runConversionFinalizationImpl(
        ...
        write_optimization_render_telemetry_summary_fn=_record("optimization_render_summary"),
        write_optimization_render_telemetry_comparison_fn=_record("optimization_render_comparison"),
    ...
    assert step_names == [
        ...
        "bestlist_metrics",
        "batch_failure",
        "optimization_render_summary",
        "optimization_render_comparison",
        "strategy_switch",
        "write_iteration_log",
        "harmonize",
        "post_reporting",
