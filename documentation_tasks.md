...
- [x] AC08-Aufgabe 3.1 ist erledigt: Adaptive Locks für dokumentierte AC08-Problemfamilien lockern bei Stagnation/hohem Restfehler nur eng begrenzte Suchraumparameter. (siehe `docs/ac08_improvement_plan.md`)
