...
PLAN_B_PERCEPTION_TARGETS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "expected_seed_kinds": {"CircleBackground", "TextGlyph"},
        "description": "Plan-B-Kandidat AC0835_S: rundes VOC-Badge ohne Griff; Kreis und zentriertes Label zuerst prüfen.",
        "glyphs": ["VOC"],
    },
    {
        "variant": "AC0861_S",
        "image_candidates": ["artifacts/images_to_convert/AC0861_S.jpg"],
        "plan_b_reason": "Anschlussprobe aus der rF-Familie: rundes rF-Badge mit senkrechtem Griff nach dem AC0850-Refresh.",
        "perception_question": "Kann der dominante rF-Kreis vorab als CircleBackground und der senkrechte Griff als Linien-Hinweis festgehalten werden?",
