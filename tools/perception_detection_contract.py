...
PLAN_B_PERCEPTION_TARGETS: list[dict[str, Any]] = [
    {
        "variant": "GE1001_M",
        "image_candidates": ["artifacts/images_to_convert/GE1001_M.jpg"],
        "plan_b_reason": "Run-RQ-Triage: höchster aktueller GE-Diff-Fehler.",
        "description": "Kompaktes GE-Symbol mit dominanten Kontur- und Farbflächen.",
        "perception_question": "Werden die dominanten Kontur- oder Farbflächen als katalogfreie Primitive erkannt?",
    ...
    {
        "variant": "GE9021_7M",
        "image_candidates": ["artifacts/images_to_convert/GE9021_7M.jpg"],
        "plan_b_reason": "Run-RQ-Triage: zweiter aktueller Diff-Fall oberhalb der Review-Grenze.",
        "description": "Schmales GE-Symbol mit vertikaler Kontur und farbigen Flächen.",
        "perception_question": "Wird die dominante vertikale Struktur als katalogfreier Linien-/Polygon- oder Farbflächenkandidat erkannt?",
