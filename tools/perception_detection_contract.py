...
PLAN_B_PERCEPTION_TARGETS: list[dict[str, Any]] = [
    {
        ...
        "plan_b_reason": "Weak-Family-Befund: rundes rF-Badge ohne Griff mit sehr hohem Text-/Grauwertfehler.",
        ...
        "description": "Plan-B-Kandidat AC0850_M: rundes rF-Badge ohne Griff; Kreis und zweibuchstabiges Label zuerst prüfen.",
        "glyphs": ["rF"],
    },
    {
        "variant": "AC0836_S",
        ...
        "plan_b_reason": "Weak-Family-Befund: rundes VOC-Badge mit senkrechtem Griff; gute nächste Probe für Kreis, Label und einfachen Connector.",
    ...
    {
        "variant": "AC0844_S",
        "image_candidates": ["artifacts/images_to_convert/AC0844_S.jpg"],
        "plan_b_reason": "Weak-Family-Befund: rundes rF-Badge mit Griff/gedrehter Lage und auffälligem Text-/Connector-Fehler.",
        ...
        "expected_first_primitive": "circle_ring_or_rf_vertical_connector",
        "expected_candidate_kinds": {"circle", "ring", "line", "text_glyph"},
        "expected_seed_kinds": {"CircleBackground", "TextGlyph"},
        "description": "Plan-B-Kandidat AC0844_S: rundes rF-Badge mit gedrehtem Griff; Kreis, Label und Griff zuerst prüfen.",
        "glyphs": ["rF"],
    },
]
