...
PLAN_B_PERCEPTION_TARGETS: list[dict[str, Any]] = [
    ...
    {
        "variant": "AC0870_S",
        "image_candidates": ["artifacts/images_to_convert/AC0870_S.jpg"],
        "plan_b_reason": "Weak-Family-Befund: rundes T-Badge mit auffälligem Textgrössen-, Zentrierungs- und Antialiasingfehler.",
        "perception_question": "Kann der dominante T-Kreis vorab als CircleBackground und das zentrierte Kurzlabel als TextGlyph-Hinweis festgehalten werden?",
        "expected_first_primitive": "circle_ring_or_t_label",
        "expected_candidate_kinds": {"circle", "ring", "text_glyph"},
        "expected_seed_kinds": {"CircleBackground", "TextGlyph"},
        "description": "Plan-B-Kandidat AC0870_S: rundes T-Badge; Kreis und zentriertes Kurzlabel zuerst prüfen.",
        "glyphs": ["T"],
    },
    {
        "variant": "AC0850_M",
