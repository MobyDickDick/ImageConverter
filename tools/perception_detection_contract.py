...
PLAN_B_PERCEPTION_TARGETS: list[dict[str, Any]] = [
    ...
    {
        "variant": "AC0861_S",
        "image_candidates": ["artifacts/images_to_convert/AC0861_S.jpg"],
        "plan_b_reason": "Weak-Family-Folgepunkt: rundes rF-Badge mit senkrechtem Griff unterhalb des Kreises.",
        "perception_question": "Kann der dominante rF-Kreis vorab als CircleBackground und der untere senkrechte Griff als Linien-Hinweis festgehalten werden?",
        "expected_first_primitive": "circle_ring_or_rf_vertical_connector",
        "expected_candidate_kinds": {"circle", "ring", "line", "text_glyph"},
        "expected_seed_kinds": {"CircleBackground", "TextGlyph"},
        "description": "Plan-B-Kandidat AC0861_S: rundes rF-Badge mit unterem senkrechtem Griff; Kreis, Label und Griff zuerst prüfen.",
        "glyphs": ["rF"],
    },
    {
        "variant": "AC0862_S",
