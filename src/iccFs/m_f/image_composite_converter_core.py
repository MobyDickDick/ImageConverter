...
class Action:
    ...
    def _enforce_semantic_component_contract(name: str, params: dict) -> dict:
        ...
        arm_only_symbols = {"AC0810", "AC0812", "AC0813", "AC0814", "AC0832", "AC0833", "AC0834", "AC0835", "AC0837", "AC0838", "AC0839", "AC0882"}
...
def _load_mainfile_function(func_name: str, filename: str):
    """Lade eine ausgelagerte Funktionsdefinition aus src/iccFs/m_f in dieses Modul."""
