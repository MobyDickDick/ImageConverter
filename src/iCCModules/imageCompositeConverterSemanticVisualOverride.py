...
def applySemanticVisualOverrideImpl(
    *,
    ...
    semantic_mode_visual_override = params.get("mode") == "semantic_badge" and bool(elongated_rect_geometry)
    if not semantic_mode_visual_override:
        return params, False

    updated_params = copy.deepcopy(params)
    updated_params["mode"] = "non_composite_visual_override"
    updated_params["visual_override_reason"] = "elongated_rect_geometry_detected"
    print_fn(
