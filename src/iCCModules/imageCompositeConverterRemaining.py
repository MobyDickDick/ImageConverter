...
def runIterationPipeline(
    ...
    run_locals = iteration_run_preparation_helpers.prepareRunIterationPipelineLocalsImpl(
        **iteration_run_preparation_helpers.buildPrepareRunIterationPipelineLocalsKwargsImpl(
            ...
            prepare_iteration_input_runtime_for_run_kwargs={
                ...
                "prepare_iteration_inputs_kwargs": iteration_run_preparation_helpers.buildPrepareIterationInputRuntimeForRunKwargsImpl(
                    img_path=img_path,
                    csv_path=csv_path,
    ...
    return iteration_execution_context_helpers.executeRunIterationPipelineImpl(
        **iteration_execution_context_helpers.buildExecuteRunIterationPipelineKwargsImpl(
