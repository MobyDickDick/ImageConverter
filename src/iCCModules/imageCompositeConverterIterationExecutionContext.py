...
def buildExecuteRunIterationPipelineKwargsImpl(
    *,
    run_locals: dict[str, Any],
    img_path: str,
    max_iterations: int,
    ...
    return {
        ...
        "calculate_error_fn": calculate_error_fn,
        "print_fn": print_fn,
        "build_prepared_mode_builder_kwargs_for_run_pipeline_fn": build_prepared_mode_builder_kwargs_for_run_pipeline_fn,
        "build_prepared_mode_builder_kwargs_for_run_fn": build_prepared_mode_builder_kwargs_for_run_fn,
        "build_prepared_mode_builder_kwargs_fn": build_prepared_mode_builder_kwargs_fn,
        "run_prepared_iteration_and_finalize_for_run_fn": run_prepared_iteration_and_finalize_for_run_fn,
        "build_run_prepared_iteration_and_finalize_kwargs_fn": build_run_prepared_iteration_and_finalize_kwargs_fn,
        "run_prepared_iteration_and_finalize_fn": run_prepared_iteration_and_finalize_fn,
        "build_prepared_iteration_mode_kwargs_fn": build_prepared_iteration_mode_kwargs_fn,
        "run_prepared_iteration_mode_fn": run_prepared_iteration_mode_fn,
...
def executeRunIterationPipelineForRunImpl(
    *,
    run_locals: dict[str, Any],
    img_path: str,
    max_iterations: int,
    ...
    return executeRunIterationPipelineImpl(
        **buildExecuteRunIterationPipelineKwargsImpl(
            run_locals=run_locals,
            img_path=img_path,
            max_iterations=max_iterations,
            badge_validation_rounds=badge_validation_rounds,
            ...
            calculate_error_fn=calculate_error_fn,
            print_fn=print_fn,
            build_prepared_mode_builder_kwargs_for_run_pipeline_fn=buildPreparedModeBuilderKwargsForRunPipelineImpl,
            build_prepared_mode_builder_kwargs_for_run_fn=buildPreparedModeBuilderKwargsForRunImpl,
            build_prepared_mode_builder_kwargs_fn=build_prepared_mode_builder_kwargs_fn,
            run_prepared_iteration_and_finalize_for_run_fn=runPreparedIterationAndFinalizeForRunImpl,
            build_run_prepared_iteration_and_finalize_kwargs_fn=buildRunPreparedIterationAndFinalizeKwargsImpl,
            run_prepared_iteration_and_finalize_fn=run_prepared_iteration_and_finalize_fn,
            build_prepared_iteration_mode_kwargs_fn=build_prepared_iteration_mode_kwargs_fn,
            run_prepared_iteration_mode_fn=run_prepared_iteration_mode_fn,
            finalize_iteration_result_fn=finalize_iteration_result_fn,
...
def buildRunIterationPipelineForRunLocalsKwargsImpl(
    *,
    ...
    return {
        ...
        "finalize_iteration_result_fn": finalize_iteration_result_fn,
        "math_module": math_module,
        "execute_run_iteration_pipeline_for_run_fn": execute_run_iteration_pipeline_for_run_fn,
    }


def buildRunIterationPipelineForRunLocalsKwargsForRunImpl(
    *,
    run_locals: dict[str, Any] | None,
    img_path: str,
    max_iterations: int,
    ...
    return buildRunIterationPipelineForRunLocalsKwargsImpl(
        run_locals=run_locals,
        img_path=img_path,
        max_iterations=max_iterations,
        badge_validation_rounds=badge_validation_rounds,
        ...
        finalize_iteration_result_fn=finalize_iteration_result_fn,
        math_module=math_module,
        execute_run_iteration_pipeline_for_run_fn=executeRunIterationPipelineForRunImpl,
    )
...
def runIterationPipelineForRunImpl(
    *,
    run_locals: dict[str, Any] | None,
    img_path: str,
    max_iterations: int,
    ...
    return runIterationPipelineForRunLocalsImpl(
        **buildRunIterationPipelineForRunLocalsKwargsForRunImpl(
            run_locals=run_locals,
            img_path=img_path,
            max_iterations=max_iterations,
            badge_validation_rounds=badge_validation_rounds,
...
def buildRunIterationPipelineForRunCallKwargsImpl(
    *,
    run_locals: dict[str, Any] | None,
    img_path: str,
    max_iterations: int,
