...
def _default_candidate_provider(
    ...
    if "stroke_width" in element:
        ...
        if element.get("kind") == "PolygonPath":
            for delta in (
                ...
                -0.000000019073486328125,
                -0.0000000095367431640625,
                -0.00000000476837158203125,
                -0.000000002384185791015625,
                -0.0000000011920928955078125,
                -0.00000000059604644775390625,
                -0.000000000298023223876953125,
                -0.0000000001490116119384765625,
                -0.00000000007450580596923828125,
                -0.000000000037252902984619140625,
                -0.0000000000186264514923095703125,
                -0.00000000000931322574615478515625,
                -0.000000000004656612873077392578125,
                0.000000000004656612873077392578125,
                0.00000000000931322574615478515625,
                0.0000000000186264514923095703125,
                0.000000000037252902984619140625,
        ...
        if element.get("kind") in {"RectBorder", "HorizontalRule", "VerticalRule"}:
            for delta in (
                ...
                -0.00000000000931322574615478515625,
                -0.000000000004656612873077392578125,
                -0.0000000000023283064365386962890625,
                0.0000000000023283064365386962890625,
                0.000000000004656612873077392578125,
                0.00000000000931322574615478515625,
                0.0000000000186264514923095703125,
        ...
        if isinstance(stroke_gradient, dict) and isinstance(
            ...
            for stop_index, stop in enumerate(stroke_gradient["stops"]):
                ...
                for delta in (
                    ...
                    -0.00000000037252902984619140625,
                    -0.000000000186264514923095703125,
                    -0.0000000000931322574615478515625,
                    -0.00000000004656612873077392578125,
                    -0.000000000023283064365386962890625,
                    -0.0000000000116415321826934814453125,
                    0.0000000000116415321826934814453125,
                    0.000000000023283064365386962890625,
                    0.00000000004656612873077392578125,
                    0.0000000000931322574615478515625,
    ...
    if element.get("kind") in {"ColorPatch", "RectBorder"}:
        ...
        for candidate_opacity in (
            ...
            0.98281249962747097015380859375,
            0.982812499813735485076904296875,
            0.9828124999068677425384521484375,
            0.98281249995343387126922607421875,
            0.982812499976716935634613037109375,
            0.9828124999883584678173065185546875,
            0.98281249999417923390865325927734375,
            0.982812499997089616954326629638671875,
            0.9828124999985448084771633148193359375,
            0.98281249999927240423858165740966796875,
            0.982812499999636202119290828704833984375,
            0.9828124999998181010596454143524169921875,
            0.98281249999990905052982270717620849609375,
            0.982812499999954525264911353588104248046875,
            0.9828124999999772626324556767940521240234375,
            0.98281249999998863131622783839702606201171875,
            0.982812499999994315658113919198513031005859375,
            0.9828124999999971578290569595992565155029296875,
            0.98281249999999857891452847979962825775146484375,
            0.982812499999999289457264239899814128875732421875,
            0.9828125,
            0.98291015625,
            0.9830078125,
            0.983203125,
            ...
            if abs(candidate_opacity - fill_opacity) < 1e-16:
                continue
            candidate = copy.deepcopy(element)
            candidate["fill_opacity"] = candidate_opacity
            yield candidate
        ...
        for candidate_opacity in (
            ...
            0.98271484375,
            0.9828125,
            0.982812500000000710542735760100185871124267578125,
            0.98281250000000142108547152020037174224853515625,
            0.9828125000000028421709430404007434844970703125,
            0.982812500000005684341886080801486968994140625,
            0.98281250000001136868377216160297393798828125,
            0.9828125000000227373675443232059478759765625,
            0.982812500000045474735088646411895751953125,
            0.98281250000009094947017729282379150390625,
            0.9828125000001818989403545856475830078125,
            0.982812500000363797880709171295166015625,
            0.98281250000072759576141834259033203125,
            0.9828125000014551915228366851806640625,
            0.982812500002910383045673370361328125,
            0.98281250000582076609134674072265625,
            0.9828125000116415321826934814453125,
            0.982812500023283064365386962890625,
            0.98281250004656612873077392578125,
            0.9828125000931322574615478515625,
            0.982812500186264514923095703125,
            0.98281250037252902984619140625,
            ...
            if abs(candidate_opacity - stroke_opacity) < 1e-16:
                continue
            candidate = copy.deepcopy(element)
            candidate["stroke_opacity"] = candidate_opacity
            yield candidate
